...
partial class Monitoring
{
    ...
    private void InitializeComponent()
    {
        ...
        cuiBorder1.ForeColor = Color.FromArgb(9, 121, 105);
        ...
        GpuSwitch.ForeColor = Color.FromArgb(9, 121, 105);
        ...
        BatterySwitch.ForeColor = Color.FromArgb(9, 121, 105);
        ...
        RamSwitch.ForeColor = Color.FromArgb(9, 121, 105);
        ...
        DrivesSwitch.ForeColor = Color.FromArgb(9, 121, 105);
        ...
        ProcessesSwitch.ForeColor = Color.FromArgb(9, 121, 105);
